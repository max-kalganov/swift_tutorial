...
func Lesson6Challenge(){
    let people:Double = 4
    let subtotal:Double = 128
    let tax = 0.13
    var split: Double = (subtotal * (1 + tax)) / people
    print(subtotal * (1+tax), split)
...
func Lesson7Challenge(){
    func goodMorning(){
        print("Good Morning!")
    }
    
    func printTotalWithTax(subtotal s: Double){
        print(s * 1.13)
    }
    
    
    func getTotalWithTax(subtotal s: Double) -> Double{
        return s * 1.13
    }
    
    func calculateTotalWithTax(subtotal s: Double, tax t: Double) -> Double{
        return s * t
    }
    
    goodMorning()
    printTotalWithTax(subtotal: 1.0)
    print(getTotalWithTax(subtotal: 1.0))
    print(calculateTotalWithTax(subtotal: 2.2, tax: 1.5))
}

func Lesson8Challenge(){
    struct Car{
        private var make: String = "Make"
        private var model: String = "Dodge"
